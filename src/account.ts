...
export type AccountListResult = AccountListResult200
...
export type AccountGetResult = AccountGetResult200
...
export type AccountSummaryResult = AccountSummaryResult200
...
export type AccountInstrumentsResult = AccountInstrumentsResult200
...
export type AccountConfigureResult = AccountConfigureResult200 | AccountConfigureResult400
...
export type AccountChangesResult = AccountChangesResult200
...
export class API {
  ...
  async get(accountID: primitives.AccountID): Promise<AccountGetResult> {
    return new Promise((resolve, reject) => {
      new EntitySpec(this.context).get(accountID, this.resolver(resolve, reject))
    })
  }
  async summary(accountID: primitives.AccountID): Promise<AccountSummaryResult> {
    return new Promise((resolve, reject) => {
  ...
  async instruments(
    ...
    body: AccountInstrumentsRequest,
  ): Promise<AccountInstrumentsResult> {
    return new Promise((resolve, reject) => {
  ...
  async configure(
    accountID: primitives.AccountID,
    body: AccountConfigureRequest,
  ): Promise<AccountConfigureResult> {
    return new Promise((resolve, reject) => {
  ...
  async changes(
    accountID: primitives.AccountID,
    body: AccountChangesRequest,
  ): Promise<AccountChangesResult> {
    return new Promise((resolve, reject) => {
