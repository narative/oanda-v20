...
export const OrderIdentifier_Properties = [
  new Property('orderID', 'orderID', 'The OANDA-assigned Order ID', 'primitive', 'order.OrderID'),
  new Property(
    'clientOrderID',
    'clientOrderID',
...
export class OrderIdentifier extends Definition {
  /**
...
export const DynamicOrderState_Properties = [
  new Property('id', 'Order ID', "The Order's ID.", 'primitive', 'order.OrderID'),
  new Property(
    'trailingStopValue',
    'Trailing Stop Value',
...
export class DynamicOrderState extends Definition {
  /**
   * The Order's ID.
   */
  public id: primitives.OrderID

  /**
   * The Order's calculated trailing stop value.
   */
  public trailingStopValue: primitives.PriceValue

  /**
   * The distance between the Trailing Stop Loss Order's trailingStopValue and the current Market Price. This represents the distance (in price units) of the Order from a triggering price. If the distance could not be determined, this value will not be set.
   */
  public triggerDistance: primitives.PriceValue

  /**
   * True if an exact trigger distance could be calculated. If false, it means the provided trigger distance is a best estimate. If the distance could not be determined, this value will not be set.
   */
  public isTriggerDistanceExact: boolean
...
export class Order extends Definition {
  /**
   * The Order's identifier, unique within the Order's Account.
   */
  public id: primitives.OrderID
   ...
   * The time when the Order was created.
   */
  public createTime: primitives.DateTime

  /**
   * The current state of the Order.
   */
  public state: primitives.OrderState
...
export const MarketOrder_Properties = [
  new Property(
    'id',
    'Order ID',
    "The Order's identifier, unique within the Order's Account.",
...
export class MarketOrder extends Definition {
  /**
   * The Order's identifier, unique within the Order's Account.
   */
  public id: primitives.OrderID
   ...
   * The type of the Order. Always set to "MARKET" for Market Orders.
   */
  public type: primitives.OrderType
   ...
   * Details of the Trade requested to be closed, only provided when the Market Order is being used to explicitly close a Trade.
   */
  public tradeClose: transaction.MarketOrderTradeClose

  /**
   * Details of the long Position requested to be closed out, only provided when a Market Order is being used to explicitly closeout a long Position.
   */
  public longPositionCloseout: transaction.MarketOrderPositionCloseout

  /**
   * Details of the short Position requested to be closed out, only provided when a Market Order is being used to explicitly closeout a short Position.
   */
  public shortPositionCloseout: transaction.MarketOrderPositionCloseout

  /**
   * Details of the Margin Closeout that this Market Order was created for
   */
  public marginCloseout: transaction.MarketOrderMarginCloseout

  /**
   * Details of the delayed Trade close that this Market Order was created for
   */
  public delayedTradeClose: transaction.MarketOrderDelayedTradeClose

  /**
   * TakeProfitDetails specifies the details of a Take Profit Order to be created on behalf of a client. This may happen when an Order is filled that opens a Trade requiring a Take Profit, or when a Trade's dependent Take Profit Order is modified directly through the Trade.
   */
  public takeProfitOnFill: transaction.TakeProfitDetails

  /**
   * StopLossDetails specifies the details of a Stop Loss Order to be created on behalf of a client. This may happen when an Order is filled that opens a Trade requiring a Stop Loss, or when a Trade's dependent Stop Loss Order is modified directly through the Trade.
   */
  public stopLossOnFill: transaction.StopLossDetails

  /**
   * TrailingStopLossDetails specifies the details of a Trailing Stop Loss Order to be created on behalf of a client. This may happen when an Order is filled that opens a Trade requiring a Trailing Stop Loss, or when a Trade's dependent Trailing Stop Loss Order is modified directly through the Trade.
   */
  public trailingStopLossOnFill: transaction.TrailingStopLossDetails

  /**
   * Client Extensions to add to the Trade created when the Order is filled (if such a Trade is created). Do not set, modify, or delete tradeClientExtensions if your account is associated with MT4.
   */
  public tradeClientExtensions: transaction.ClientExtensions

  /**
   * ID of the Transaction that filled this Order (only provided when the Order's state is FILLED)
   */
  public fillingTransactionID: primitives.TransactionID

  /**
   * Date/time when the Order was filled (only provided when the Order's state is FILLED)
   */
  public filledTime: primitives.DateTime

  /**
   * Trade ID of Trade opened when the Order was filled (only provided when the Order's state is FILLED and a Trade was opened as a result of the fill)
   */
  public tradeOpenedID: primitives.TradeID

  /**
   * Trade ID of Trade reduced when the Order was filled (only provided when the Order's state is FILLED and a Trade was reduced as a result of the fill)
   */
  public tradeReducedID: primitives.TradeID

  /**
   * Trade IDs of Trades closed when the Order was filled (only provided when the Order's state is FILLED and one or more Trades were closed as a result of the fill)
   */
  public tradeClosedIDs: primitives.TradeID[]
   ...
   * Date/time when the Order was cancelled (only provided when the state of the Order is CANCELLED)
   */
  public cancelledTime: primitives.DateTime
  ...
  constructor(data) {
    ...
    if (data['longPositionCloseout'] !== undefined) {
      this.longPositionCloseout = new transaction.MarketOrderPositionCloseout(
        data['longPositionCloseout'],
      )
    }

    if (data['shortPositionCloseout'] !== undefined) {
      this.shortPositionCloseout = new transaction.MarketOrderPositionCloseout(
    ...
    if (data['delayedTradeClose'] !== undefined) {
      this.delayedTradeClose = new transaction.MarketOrderDelayedTradeClose(
    ...
    if (data['trailingStopLossOnFill'] !== undefined) {
      this.trailingStopLossOnFill = new transaction.TrailingStopLossDetails(
...
export const FixedPriceOrder_Properties = [
  new Property(
    'id',
    'Order ID',
    "The Order's identifier, unique within the Order's Account.",
...
export class FixedPriceOrder extends Definition {
  /**
   * The Order's identifier, unique within the Order's Account.
   */
  public id: primitives.OrderID
...
export const LimitOrder_Properties = [
  new Property(
    'id',
    'Order ID',
    "The Order's identifier, unique within the Order's Account.",
...
export class LimitOrder extends Definition {
  /**
   * The Order's identifier, unique within the Order's Account.
   */
  public id: primitives.OrderID
...
export const StopOrder_Properties = [
  new Property(
    'id',
    'Order ID',
    "The Order's identifier, unique within the Order's Account.",
...
export class StopOrder extends Definition {
  /**
   * The Order's identifier, unique within the Order's Account.
   */
  public id: primitives.OrderID
...
export const MarketIfTouchedOrder_Properties = [
  new Property(
    'id',
    'Order ID',
    "The Order's identifier, unique within the Order's Account.",
...
export class MarketIfTouchedOrder extends Definition {
  /**
   * The Order's identifier, unique within the Order's Account.
   */
  public id: primitives.OrderID
 ...
 */
   ...
   * The Market price at the time when the MarketIfTouched Order was created.
   */
  public initialMarketPrice: primitives.PriceValue
...
export const TakeProfitOrder_Properties = [
  new Property(
    'id',
    'Order ID',
    "The Order's identifier, unique within the Order's Account.",
...
export class TakeProfitOrder extends Definition {
  /**
   * The Order's identifier, unique within the Order's Account.
   */
  public id: primitives.OrderID
...
export const StopLossOrder_Properties = [
  new Property(
    'id',
    'Order ID',
    "The Order's identifier, unique within the Order's Account.",
...
export class StopLossOrder extends Definition {
  /**
   * The Order's identifier, unique within the Order's Account.
   */
  public id: primitives.OrderID
...
export const TrailingStopLossOrder_Properties = [
  new Property(
    'id',
    'Order ID',
    "The Order's identifier, unique within the Order's Account.",
...
export class TrailingStopLossOrder extends Definition {
  /**
   * The Order's identifier, unique within the Order's Account.
   */
  public id: primitives.OrderID
...
export const OrderRequest_Properties = []

export class OrderRequest extends Definition {
  constructor(data) {
    super()
...
export const MarketOrderRequest_Properties = [
  new Property(
    'type',
    'Type',
...
export class MarketOrderRequest extends Definition {
  /**
   * The type of the Order to Create. Must be set to "MARKET" when creating a Market Order.
   */
  public type: primitives.OrderType
...
export const LimitOrderRequest_Properties = [
  new Property(
    'type',
    'Type',
...
export class LimitOrderRequest extends Definition {
  /**
   * The type of the Order to Create. Must be set to "LIMIT" when creating a Market Order.
   */
  public type: primitives.OrderType
...
export const StopOrderRequest_Properties = [
  new Property(
    'type',
    'Type',
...
export class StopOrderRequest extends Definition {
  /**
   * The type of the Order to Create. Must be set to "STOP" when creating a Stop Order.
   */
  public type: primitives.OrderType
...
export const MarketIfTouchedOrderRequest_Properties = [
  new Property(
    'type',
    'Type',
...
export class MarketIfTouchedOrderRequest extends Definition {
  /**
   * The type of the Order to Create. Must be set to "MARKET_IF_TOUCHED" when creating a Market If Touched Order.
   */
  public type: primitives.OrderType
...
export const TakeProfitOrderRequest_Properties = [
  new Property(
    'type',
    'Type',
...
export class TakeProfitOrderRequest extends Definition {
  /**
   * The type of the Order to Create. Must be set to "TAKE_PROFIT" when creating a Take Profit Order.
   */
  public type: primitives.OrderType
...
export const StopLossOrderRequest_Properties = [
  new Property(
    'type',
    'Type',
...
export class StopLossOrderRequest extends Definition {
  /**
   * The type of the Order to Create. Must be set to "STOP_LOSS" when creating a Stop Loss Order.
   */
  public type: primitives.OrderType
...
export const TrailingStopLossOrderRequest_Properties = [
  new Property(
    'type',
    'Type',
...
export class TrailingStopLossOrderRequest extends Definition {
  /**
   * The type of the Order to Create. Must be set to "TRAILING_STOP_LOSS" when creating a Trailng Stop Loss Order.
   */
  public type: primitives.OrderType
...
export const UnitsAvailableDetails_Properties = [
  new Property(
    'long',
    'Long',
...
export class UnitsAvailableDetails extends Definition {
  /**
   * The units available for long Orders.
   */
  public long: primitives.DecimalNumber

  /**
   * The units available for short Orders.
   */
  public short: primitives.DecimalNumber
...
export const UnitsAvailable_Properties = [
  new Property(
    'default',
    'Default',
...
export class UnitsAvailable extends Definition {
  /**
   * The number of units that are available to be traded using an Order with a positionFill option of "DEFAULT". For an Account with hedging enabled, this value will be the same as the "OPEN_ONLY" value. For an Account without hedging enabled, this value will be the same as the "REDUCE_FIRST" value.
   */
  public default: UnitsAvailableDetails

  /**
   * The number of units that may are available to be traded with an Order with a positionFill option of "REDUCE_FIRST".
   */
  public reduceFirst: UnitsAvailableDetails

  /**
   * The number of units that may are available to be traded with an Order with a positionFill option of "REDUCE_ONLY".
   */
  public reduceOnly: UnitsAvailableDetails

  /**
   * The number of units that may are available to be traded with an Order with a positionFill option of "OPEN_ONLY".
   */
  public openOnly: UnitsAvailableDetails
...
export const GuaranteedStopLossOrderEntryData_Properties = [
  new Property(
    'minimumDistance',
    'minimumDistance',
...
export class GuaranteedStopLossOrderEntryData extends Definition {
  /**
   * The minimum distance allowed between the Trade's fill price and the configured price for guaranteed Stop Loss Orders created for this instrument. Specified in price units.
   */
  public minimumDistance: primitives.DecimalNumber

  /**
   * The amount that is charged to the account if a guaranteed Stop Loss Order is triggered and filled. The value is in price units and is charged for each unit of the Trade.
   */
  public premium: primitives.DecimalNumber

  /**
   * The guaranteed Stop Loss Order level restriction for this instrument.
   */
  public levelRestriction: primitives.GuaranteedStopLossOrderLevelRestriction
  ...
  constructor(data) {
    ...
    if (data['levelRestriction'] !== undefined) {
      this.levelRestriction = new primitives.GuaranteedStopLossOrderLevelRestriction(
...
export class EntitySpec {
  ...
  public DynamicOrderState = DynamicOrderState
  public Order = Order
  public MarketOrder = MarketOrder
  public FixedPriceOrder = FixedPriceOrder
  public LimitOrder = LimitOrder
  public StopOrder = StopOrder
  public MarketIfTouchedOrder = MarketIfTouchedOrder
  ...
  public MarketOrderRequest = MarketOrderRequest
  public LimitOrderRequest = LimitOrderRequest
  public StopOrderRequest = StopOrderRequest
  public MarketIfTouchedOrderRequest = MarketIfTouchedOrderRequest
  public TakeProfitOrderRequest = TakeProfitOrderRequest
  public StopLossOrderRequest = StopLossOrderRequest
  public TrailingStopLossOrderRequest = TrailingStopLossOrderRequest
  public UnitsAvailableDetails = UnitsAvailableDetails
  public UnitsAvailable = UnitsAvailable
  public GuaranteedStopLossOrderEntryData = GuaranteedStopLossOrderEntryData
      ...
      if (response.contentType.startsWith('application/json')) {
        ...
        if (response.statusCode == 201) {
          if (msg['orderCreateTransaction'] !== undefined) {
            response.body.orderCreateTransaction = transaction.Transaction.create(
          ...
          if (msg['orderReissueTransaction'] !== undefined) {
            response.body.orderReissueTransaction = transaction.Transaction.create(
              msg['orderReissueTransaction'],
            )
          }

          if (msg['orderReissueRejectTransaction'] !== undefined) {
            response.body.orderReissueRejectTransaction = transaction.Transaction.create(
              msg['orderReissueRejectTransaction'],
            )
          }
          ...
          if (msg['orderRejectTransaction'] !== undefined) {
            response.body.orderRejectTransaction = transaction.Transaction.create(
      ...
      if (response.contentType.startsWith('application/json')) {
        ...
        if (response.statusCode == 201) {
          ...
          if (msg['replacingOrderCancelTransaction'] !== undefined) {
            response.body.replacingOrderCancelTransaction = new transaction.OrderCancelTransaction(
              msg['replacingOrderCancelTransaction'],
            )
          }
          ...
          if (msg['orderCancelRejectTransaction'] !== undefined) {
            response.body.orderCancelRejectTransaction = transaction.Transaction.create(
              msg['orderCancelRejectTransaction'],
            )
          }
    ...
    let handleResponse = (err, response) => {
      ...
      if (response.contentType.startsWith('application/json')) {
        ...
        if (response.statusCode == 200) {
          ...
          if (msg['orderCancelRejectTransaction'] !== undefined) {
            response.body.orderCancelRejectTransaction = new transaction.OrderCancelRejectTransaction(
              msg['orderCancelRejectTransaction'],
            )
          }
      ...
      if (response.contentType.startsWith('application/json')) {
        ...
        if (response.statusCode == 200) {
          if (msg['orderClientExtensionsModifyTransaction'] !== undefined) {
            response.body.orderClientExtensionsModifyTransaction = new transaction.OrderClientExtensionsModifyTransaction(
              msg['orderClientExtensionsModifyTransaction'],
            )
          }
          ...
          if (msg['orderClientExtensionsModifyRejectTransaction'] !== undefined) {
            response.body.orderClientExtensionsModifyRejectTransaction = new transaction.OrderClientExtensionsModifyRejectTransaction(
              msg['orderClientExtensionsModifyRejectTransaction'],
            )
          }
...
export interface OrderCreateRequestBody {
  /**
...
export interface OrderListRequest {
  ids: string
  state: primitives.OrderStateFilter
  instrument: primitives.InstrumentName
  count: number
  beforeID: primitives.OrderID
}

export interface OrderReplaceRequest {
  body: OrderReplaceRequestBody
}
export interface OrderReplaceRequestBody {
  /**
...
export interface OrderSetClientExtensionsRequest {
  body: OrderSetClientExtensionsRequestBody
}
export interface OrderSetClientExtensionsRequestBody {
  /**
   ...
   * associated with MT4.
   */
  tradeClientExtensions?: primitives.ClientExtensions
}

export type OrderCreateResult = OrderCreateResult400

export interface OrderCreateResult400 {
  /**
...
export type OrderListResult = OrderListResult200

export interface OrderListResult200 {
  /**
...
export type OrderListPendingResult = OrderListPendingResult200

export interface OrderListPendingResult200 {
  /**
...
export type OrderGetResult = OrderGetResult200

export interface OrderGetResult200 {
  /**
...
export type OrderReplaceResult = OrderReplaceResult400

export interface OrderReplaceResult400 {
  /**
...
export type OrderCancelResult = OrderCancelResult200

export interface OrderCancelResult200 {
  /**
...
export type OrderSetClientExtensionsResult =
  | OrderSetClientExtensionsResult200
  | OrderSetClientExtensionsResult400

export interface OrderSetClientExtensionsResult200 {
  /**
...
export interface OrderSetClientExtensionsResult400 {
  /**
...
export class API {
  ...
  async list(accountID: primitives.AccountID, body: OrderListRequest): Promise<OrderListResult> {
    return new Promise((resolve, reject) => {
      new EntitySpec(this.context).list(accountID, body, this.resolver(resolve, reject))
    })
  }
  async listPending(accountID: primitives.AccountID): Promise<OrderListPendingResult> {
    return new Promise((resolve, reject) => {
  ...
  async get(
    accountID: primitives.AccountID,
    orderSpecifier: primitives.OrderSpecifier,
  ...
  async setClientExtensions(
    accountID: primitives.AccountID,
    orderSpecifier: primitives.OrderSpecifier,
    body: OrderSetClientExtensionsRequest,
  ): Promise<OrderSetClientExtensionsResult> {
    return new Promise((resolve, reject) => {
