...
export type TransactionListResult = TransactionListResult200
...
export type TransactionGetResult = TransactionGetResult200
...
export type TransactionRangeResult = TransactionRangeResult200
...
export type TransactionSinceResult = TransactionSinceResult200
...
export class API {
  ...
  async range(
    accountID: primitives.AccountID,
    body: TransactionRangeRequest,
  ): Promise<TransactionRangeResult> {
    return new Promise((resolve, reject) => {
  ...
  async since(
    accountID: primitives.AccountID,
    body: TransactionSinceRequest,
  ): Promise<TransactionSinceResult> {
    return new Promise((resolve, reject) => {
      new EntitySpec(this.context).since(accountID, body, this.resolver(resolve, reject))
    })
  }
  async stream(accountID: primitives.AccountID, streamHandler): Promise<void> {
    return new Promise((resolve, reject) => {
