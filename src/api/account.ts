...
export class API {
  ...
  async get(request: GetRequest) {
    return new Promise((resolve, reject) => {
      new EntitySpec(this.context).get(request.accountID, this.resolver(resolve, reject))
    })
  }
   ...
   */
  async summary(request: SummaryRequest) {
    return new Promise((resolve, reject) => {
      new EntitySpec(this.context).summary(request.accountID, this.resolver(resolve, reject))
    })
  }
   ...
   */
  async instruments(request: InstrumentsRequest) {
    return new Promise((resolve, reject) => {
   ...
   */
  async changes(request: ChangesRequest) {
    return new Promise((resolve, reject) => {
