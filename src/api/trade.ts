...
export type SetDependentOrdersResponse =
  | SetDependentOrdersResponse200
  | SetDependentOrdersResponse400
...
export class API {
   ...
   */
  async setDependentOrders(request: SetDependentOrdersRequest) {
    return new Promise((resolve, reject) => {
