...
export interface InstrumentCandlesRequest {
...
export interface InstrumentOrderBookRequest {
  time: primitives.DateTime
}

export interface InstrumentPositionBookRequest {
  time: primitives.DateTime
}

export type InstrumentCandlesResult = InstrumentCandlesResult200

export interface InstrumentCandlesResult200 {
  /**
...
export type InstrumentOrderBookResult = InstrumentOrderBookResult200

export interface InstrumentOrderBookResult200 {
  /**
...
export type InstrumentPositionBookResult = InstrumentPositionBookResult200

export interface InstrumentPositionBookResult200 {
  /**
...
export class API {
  ...
  async candles(
    instrument: primitives.InstrumentName,
    body: InstrumentCandlesRequest,
  ): Promise<InstrumentCandlesResult> {
    return new Promise((resolve, reject) => {
      new EntitySpec(this.context).candles(instrument, body, this.resolver(resolve, reject))
    })
  }
  async orderBook(
    instrument: primitives.InstrumentName,
    body: InstrumentOrderBookRequest,
  ): Promise<InstrumentOrderBookResult> {
    return new Promise((resolve, reject) => {
      new EntitySpec(this.context).orderBook(instrument, body, this.resolver(resolve, reject))
    })
  }
  async positionBook(
    instrument: primitives.InstrumentName,
    body: InstrumentPositionBookRequest,
  ): Promise<InstrumentPositionBookResult> {
    return new Promise((resolve, reject) => {
      new EntitySpec(this.context).positionBook(instrument, body, this.resolver(resolve, reject))
    })
  }
}
