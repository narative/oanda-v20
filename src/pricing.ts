...
export type PricingGetResult = PricingGetResult200
...
export type PricingCandlesResult = PricingCandlesResult200
...
export class API {
  ...
  async get(accountID: primitives.AccountID, body: PricingGetRequest): Promise<PricingGetResult> {
  ...
  async candles(
    instrument: primitives.InstrumentName,
    body: PricingCandlesRequest,
    chunkHandler,
  ): Promise<PricingCandlesResult> {
    return new Promise((resolve, reject) => {
