...
export declare type InstrumentCandlesResult = InstrumentCandlesResult200;
...
export declare type InstrumentOrderBookResult = InstrumentOrderBookResult200;
...
export declare type InstrumentPositionBookResult = InstrumentPositionBookResult200;
...
export declare class API {
    ...
    candles(instrument: primitives.InstrumentName, body: InstrumentCandlesRequest): Promise<InstrumentCandlesResult>;
    orderBook(instrument: primitives.InstrumentName, body: InstrumentOrderBookRequest): Promise<InstrumentOrderBookResult>;
    positionBook(instrument: primitives.InstrumentName, body: InstrumentPositionBookRequest): Promise<InstrumentPositionBookResult>;
}
