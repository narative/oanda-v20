...
export declare type OrderCreateResult = OrderCreateResult400;
...
export declare type OrderListResult = OrderListResult200;
...
export declare type OrderListPendingResult = OrderListPendingResult200;
...
export declare type OrderGetResult = OrderGetResult200;
...
export declare type OrderReplaceResult = OrderReplaceResult400;
...
export declare type OrderCancelResult = OrderCancelResult200;
...
export declare type OrderSetClientExtensionsResult = OrderSetClientExtensionsResult200 | OrderSetClientExtensionsResult400;
...
export declare class API {
    ...
    create(accountID: primitives.AccountID, body: OrderCreateRequest): Promise<OrderCreateResult>;
    list(accountID: primitives.AccountID, body: OrderListRequest): Promise<OrderListResult>;
    listPending(accountID: primitives.AccountID): Promise<OrderListPendingResult>;
    get(accountID: primitives.AccountID, orderSpecifier: primitives.OrderSpecifier): Promise<OrderGetResult>;
    replace(accountID: primitives.AccountID, orderSpecifier: primitives.OrderSpecifier, body: OrderReplaceRequest): Promise<OrderReplaceResult>;
    cancel(accountID: primitives.AccountID, orderSpecifier: primitives.OrderSpecifier): Promise<OrderCancelResult>;
    setClientExtensions(accountID: primitives.AccountID, orderSpecifier: primitives.OrderSpecifier, body: OrderSetClientExtensionsRequest): Promise<OrderSetClientExtensionsResult>;
}
